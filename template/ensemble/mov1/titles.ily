...
\header {
  ...
  subtitle = \markup {
    \left-align
    \column
    \center-align {\fontsize #4 \lower #3 \concat { \char ##x2014 \hspace #2 \thisIdentifierMovI \hspace #2 \char ##x2014 } }
 }
  composer = \markup \center-column {\fontsize #4 \thisComposer}
  opus = \markup \center-column {\fontsize #3 \lower #0 \thisOpus}
  piece = \markup { \fontsize #5 \raise #1 { \hspace #20 \thisTempoMovI } }
}
