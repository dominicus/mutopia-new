...
\paper {
 ...
 reference = \markup {
    \fill-line {
      \concat {
        \abs-fontsize #8 {
          \thisBigTitle \hspace #0.4 \char ##x2014 \hspace #0.4             %---- ../common/variables.ily
          \combinedPublicationName \hspace #0.4 \char ##x2014 \hspace #0.4  %---- ../common/variables.ily
          \thisRevision                             %---------------------------- ../common/variables.ily
        }
      }
    }
  }
