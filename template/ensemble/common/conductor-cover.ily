...
PageToc = \markup {
  \override #'(line-width . 145)
    ...
    \column {
      ...
      \fill-line { \null }
      \fill-line {\override #'(line-width . 70) \lower #10 \toc-line #'MvmtI \concat { \hspace #3.2 \thisIdentifierMovI " - " \thisTempoMovI } }
      \fill-line {\override #'(line-width . 70) \lower #6 \toc-line #'MvmtII \concat { \hspace #1.5 \thisIdentifierMovII " - " \thisTempoMovII } }
      \fill-line {\override #'(line-width . 70) \lower #6 \toc-line #'MvmtIII \concat { \thisIdentifierMovIII " - " \thisTempoMovIII } }
