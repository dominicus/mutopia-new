...
\paper {
  ...
  reference = \markup {
    \fill-line {
      \concat {
        \abs-fontsize #8 {
          \thisCatalogIdentification   %------------------------ ../common/variables.ily
          \PartShort                   %------------------------   defined where this file is inserted into
          \hspace #0.5 \thisRevision   %------------------------ ../common/variables.ily
        }
      }
    }
  }
  ...
  thisPart = \markup {
    ...
    \column
    \center-align {
      \fontsize #3 \bold \Part         %------------------------   defined where this file is inserted into
    }
  }
  ...
  oddHeaderMarkup = \markup {
    \column {
      \fill-line {
        ...
        {
          \center-column {
            \lower #2 \fontsize #-1 \thisPart   %---------------- defined earlier this file
          }
        }
        {
          " "
  ...
  evenFooterMarkup = \markup { \override #'( baseline-skip . 0.5 )
    \column {
      ...
      \fill-line { \on-the-fly #not-part-first-page {
                                                     \reference    %---  defined earlier this file
                   }
      }
    }
  }
