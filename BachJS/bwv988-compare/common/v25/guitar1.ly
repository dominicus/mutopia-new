\version "2.18.0"
 ...
 \repeat volta 2 {
    ...
    r16 d16 [ \grace ees16 d32 cis d16 ] \slurUp \appoggiatura d16 d'8 ~ [ d32 c bes a ] g [ f \TUpb as16 ~ as32 d, \TInh f16 ~ ] | % 5
    ...
    b16 [ bes ~ bes32 a gis16 ~ ] gis [ \TInh a ~ a32 d, c bes ] c [ a bes g f e f d' ] | % 11
    f,32 \prallprall [ e f16 e8 ] r32 d32 [ cis d e f g a ] bes [ a \TUpa d16 ~ d32 cis e16 ~ ] | % 12
    e16 [ a, \grace bes16 a32 gis a16 ] \slurUp \appoggiatura a16 \TInh a'8 ~ [ a32 bes (a gis ) ] a-. [ d, c bes c-. c (bes a ) ] | % 13
 ...
 \repeat volta 2 {
    ...
    es32 [ \SDna a ( bes16 es, d ) ] r4 r4 | % 21
    r16 bes16 [ \grace ces16 bes32 as bes16 ] bes [ \TUpa bes' ~ bes32 ces bes as ] bes16 [ \TUpa des, ~ des32 ces! \TUpa bes16 ~ ] | % 22
    bes16 [ ces
    \grace des16 ces32 bes ces16 ] ces [ \TInh ces' ~ ces32 fes, es d] es [ des' c8 es,16 ] | % 23
    ...
    \grace es16 d32 cis d16 ] d'8 ~ [ d32 c bes a ] g [ d' \TInh f,16 ~ f32 es d c ] | % 30
