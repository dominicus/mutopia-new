\version "2.18.0"
 ...
 \repeat volta 2 {
    ...
    as16 [ g as bes ] es, [ d es g ] c, [ d es c ] f8 [ \TInb bes, ~ ] | % 11
    bes8 [ as16 g ] as8  [ \TIne f'8 ~ ] f [ es16 d ] es8 r8 | % 12
    r16 fis,16 [ g a ] g [ fis es d ] d' [ c d8 ] g, r8 | % 13
    r8 es'16 [ d ] c [ bes a g ] fis8  r8 r8 \TUp d'8 ~ | % 14
    d8 [ c ] b [ c16 d ] es8 [ g, fis \TInb d' ~ ] | % 15
